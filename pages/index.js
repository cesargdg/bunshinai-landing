  ...
  return (
    <>
      <div className="home-container10">
        ...
        <section className="bunshin-hero">
          ...
          <div className="hero-container">
            <div className="hero-content">
              <div className="home-thq-content-wrapper-elm content-wrapper">
                <div className="headline-group">
                  <div className="japanese-accent"></div>
                  <h1 className="home-thq-hero-headline-elm hero-headline">
                    <span>
                      {' '}
                ...
                <p className="hero-subheadline">
                  ...
                  <span className="home-text15">céntrate en crecer</span>
                </p>
                  ...
                  >
                    <div className="cta-button">
                      <span className="button-text">
                        Descubre como podemos ayudarte a crecer
                      </span>
        ...
        <div className="home-thq-bg-pattern-elm bg-pattern"></div>
                ...
                <div className="card-content">
                  ...
                  <div className="content-block solution-block">
                    ...
                    <div className="block-content">
                      ...
                      <p className="block-text">
                        Implementamos un sistema de IA que cualifica
                        propietarios, prioriza oportunidades y automatiza el
                        seguimiento multicanal (email, WhatsApp...)
                      </p>
                    </div>
                  </div>
                  <div className="results-block content-block">
                    ...
                    <div className="block-content">
                      ...
                      <div className="metrics-grid">
                        ...
                        <div className="metric">
                          <span className="metric-value">-3h</span>
                          <span className="metric-label">
                ...
                <div className="card-content">
                  ...
                  <div className="results-block content-block">
                    ...
                    <div className="block-content">
                      ...
                      <div className="metrics-grid">
                        <div className="metric">
                          <span className="metric-value">+122%</span>
                          <span className="metric-label">
                            {' '}
                        ...
                        <div className="metric">
                          <span className="metric-value">2.6x</span>
                          <span className="metric-label">
                            leads cualificados
                          </span>
                        </div>
                        <div className="metric">
                          <span className="metric-value">0.65x</span>
                          <span className="metric-label">
            ...
            <div className="services-grid">
                ...
                <div className="services-list">
                  <div id="service-2" className="service-item">
                    ...
                    <div className="service-content">
                      ...
                      <p className="service-description">
                        Automatizamos la busqueda y contacto de leads para que
                        te enfoques en proveer el servicio
                      </p>
                    </div>
                  ...
                  <div id="service-3" className="service-item">
                    ...
                    <div className="service-content">
                      ...
                      <p className="service-description">
                        {' '}
                        Construimos modelos que te ayuden a gestionar las dudas
                        y problemas de tus clientes de manera automática para
                        que solo tengas que ocuparte de los casos graves
                      </p>
                    </div>
                    <div className="service-hover-indicator">
                      <svg
              ...
              <div className="tech-column">
                <div className="tech-showcase">
                  ...
                  />
                  <div className="home-thq-tech-image-container-elm tech-image-container"></div>
                  <p className="tech-description">
                    <span>
                      Soy César, especialista en automatizacion e IA para la
                      gestión de clientes. Antes de lanzar BunshinAI, trabajé
                      como ejecutivo de Amazon, donde implementé y optimicé
                      procesos para algunas de las compañias más grandes del
                      mundo como Samsung o Lenovo.
                    </span>
                    <br></br>
                    <br></br>
                    <span>
                      Hoy aplico este conocimiento para ofrecer soluciones de
                      IA, antes reservadas para grandes corporaciones, a
                      empresas pequeñas y medianas que quieren escalar con
                      sistemas eficientes
                    </span>
                    <br></br>
                  </p>
          ...
          <div className="cta-content-wrapper">
            ...
            <div className="cta-button-wrapper">
              <a
                ...
                id="ctaButton"
              >
                <address className="home-thq-cta-button-elm2 home-cta-button">
                  ...
                  <span className="home-thq-cta-button-text-elm cta-button-text">
            ...
            <div className="cta-secondary-contact">
              ...
              <span className="cta-contact-text">
                ...
                <a href="mailto:hello@bunshinai.com?subject=">
                  <div className="home-thq-cta-email-link-elm">
                    <span>
                      {' '}
                      cesar@bunshinai.com
                      <span
  ...
  updateParallax()
      ...
      <style jsx>
        {`
          ...
          .home-thq-content-wrapper-elm {
            height: 386px;
          }
          .home-thq-hero-headline-elm {
            width: 844px;
          }
          .home-text11 {
            color: #dc143c;
          ...
          .home-thq-tech-image-container-elm {
          ...
          .home-thq-cta-button-elm2 {
            text-decoration: none;
          }
          .home-thq-cta-button-text-elm {
            text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.25);
          }
          .home-thq-cta-email-link-elm {
            color: #dc143c;
